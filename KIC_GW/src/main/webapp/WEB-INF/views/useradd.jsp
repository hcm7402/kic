...
<body>
	<div id="main">
		...
		<div class="wrap-login100">
			<form class="login100-form validate-form" action="./useradd_ok.do" name="frm" method="get">
				<div class="wrap-input100" data-validate = "Enter username">
					<input class="input100" type="text" name="ename" id="ename">
				...
				<div class="wrap-input100" data-validate = "Enter hiredate">
					<input class="input100" type="text" name="hiredate" id="hiredate">
					<span class="focus-input100" data-placeholder="입사일"></span>
				</div>
				<div class="wrap-input100" data-validate = "Enter sal">
					<input class="input100" type="text" name="sal" id="sal">
					<span class="focus-input100" data-placeholder="연봉"></span>
				</div>
				<div class="wrap-input100" data-validate = "Enter birth">
					<input class="input100" type="text" name="birth" id="birth">
					<span class="focus-input100" data-placeholder="생년월일"></span>
				</div>
				<div>
					부서 :
				...
				<div class="wrap-input100">
					도장이미지 : <input type="file" style="float: right" name="authphoto" id="authphoto">
				</div>
