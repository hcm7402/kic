...
<div class="con_txt">
	<div class="contents_sub">
		...
		<div class="btn_area">
			...
			<div style="float:right;" class="light-button submit-wrapper button_modify" data-seqv="<%=seq %>">
					<div class="submit">
						<span>
							수정
						</span>
				...
				<div style="float:right;" class="light-button submit-wrapper button_delete_ok" data-seqv="<%=seq %>">
					<div class="submit">
						<span>
							삭제
						</span>
